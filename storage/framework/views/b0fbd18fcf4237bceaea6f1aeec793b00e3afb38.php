            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        <?php echo e(date('Y')); ?> &copy; <?php echo e(__('Design by')); ?> <a href="<?php echo e(__('https://www.indiagraphics.in')); ?>" target="_blank"><?php echo e(__('India Graphics Team')); ?></a>
                    </div>
                    <div class="col-md-6">
...
<?php /**PATH /home/dharamshalaonlin/public_html/modules/Layout/admin/app.blade.php ENDPATH**/ ?>